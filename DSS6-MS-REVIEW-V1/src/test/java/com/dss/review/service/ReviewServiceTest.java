...
public class ReviewServiceTest {
    ...
    @Test
    public void shouldThrowFieldValidationExceptionOnUIDCreateReview(){
        String mvid = "3d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String rid = "5d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String uid = "afb1dc11-c222-4256-8c6d-ecc798acd303";
        String wrong_uid = "afba1dc11-c222-4256-8c6d-ecc798acd303";
        ...
        Assert.assertThrows(FieldValidationException.class
                ,() -> reviewService.createReview(reviewForm, wrong_uid, mvid));
    }

    @Test
    public void shouldThrowFieldValidationExceptionOnMVIDCreateReview(){
        String mvid = "3d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String rid = "5d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String uid = "afb1dc11-c222-4256-8c6d-ecc798acd303";
        String wrong_mvid = "3dd1ba0ae-b055-4b31-80c9-31d7dc86a717";
        ...
        Assert.assertThrows(FieldValidationException.class
                ,() -> reviewService.createReview(reviewForm, uid, wrong_mvid));
    }
    ...
    @Test
    public void shouldThrowFieldValidationExceptionRIDOnGetMovieReview(){
        String mvid = "3d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String rid = "5d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String wrong_rid = "5d1ba0aae-b055-4b31-80c9-31d7dc86a717";
        ...
        Assert.assertThrows(FieldValidationException.class
                , () ->reviewService.viewMovieReview(mvid, wrong_rid));
    }

    @Test
    public void shouldThrowFieldValidationExceptionMVIDOnGetMovieReview(){
        String mvid = "3d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String rid = "5d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String wrong_mvid = "3d1baa0ae-b055-4b31-80c9-31d7dc86a717";
        ...
        Assert.assertThrows(FieldValidationException.class
                , () ->reviewService.viewMovieReview(wrong_mvid, rid));
    }
    @Test
    ...
    @Test
    public void shouldThrowFieldValidationErrorWhenGetAllReviewOfMovie() {
        String mvid = "3d1ba0ae-b055-4b31-80c9-31d7dc86a717";

        Mockito.when(movieRepository.existsById(eq(UUID.fromString(mvid))))
                .thenReturn(Boolean.TRUE);
    ...
    @Test
    public void shouldThrowFieldValidationErrorOfMVIDWhenGetAllReviewOfMovie() {
        String mvid = "3d1ba0ae-b055-4b31-80c9-31d7dc86a717";
        String wrong_mvid = "3d1baa0ae-b055-4b31-80c9-31d7dc86a717";
        Mockito.when(movieRepository.existsById(eq(UUID.fromString(mvid))))
                .thenReturn(Boolean.TRUE);
        ...
        Assert.assertThrows(FieldValidationException.class
                , () -> reviewService.viewMovieReviews(wrong_mvid, 1, 10, null, null));
